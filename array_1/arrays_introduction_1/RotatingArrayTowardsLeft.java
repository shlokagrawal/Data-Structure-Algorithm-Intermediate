...
import java.util.Scanner; // refer lecture 4._Introduction_to_Arrays

public class RotatingArrayTowardsLeft {
	...
	public static void main(String[] args) {
		...
		reverseArray(arr, 0, (size - 1) - rotation);

		reverseArray(arr, ((size - 1) - rotation) + 1, size - 1);
